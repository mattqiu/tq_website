  ...
  <div class="design_page">
    ...
    <volist name="themes" id="vo">
      <li style="height: auto;">
        ...
        <div class="title" title="default" style="margin-top: 3px;">{$vo.name}</div>
        <div class="ft" style="position: static; "> <span class="org"><if condition="$vo['use']==1"><i>已使用</i><else/><a href="{:U("Template/Theme/chose",array("theme"=>$vo[name]))}">未使用</a></if></span></div>
      </li>
      </volist>
    </ul>
  </div>
