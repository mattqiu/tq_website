...
<main>
    ...
    <div class="guide_warp">
        <div class="container">
            ...
            <div id="guide_scr" class="owl-carousel">
                ...
                <div class="item"><a href="{:U('lists', array('catid'=>19))}" class="guide_cur"><span>联系我们</span></a></div>
            </div>
            <!--guide_scr end-->
        </div>
    </div>
    ...
    <div class="container">
        <!--intro begin-->
        <div id="content"><textarea style="display:none;">{:getCustomData(2)}</textarea></div>
        <!--intro end-->
    </div>
    <!--container end-->
</main>
