...
class Form {
     ...
     */
    public static function markdown($textareaid = 'content', $height = 640, $catid = '', $module = '') {
        ...
        if (!defined('MARKDOWN_INIT')) {
            ...
            define('MARKDOWN_INIT', 1);
        }
        $str .= "\r\n<script type=\"text/javascript\">\r\n";
        $str .= "var markdown{$textareaid} = editormd('{$textareaid}',{
                    imageUpload    : true,
                    imageFormats   : ['jpg', 'jpeg', 'gif', 'png', 'bmp', 'webp'],
                    imageUploadURL : 'index.php?g=Attachment&m=Markdown&a=run&catid={$catid}&isadmin={$isadmin}&module={$module}&uid={$userid}&groupid={$groupid}&sessid={$sess_id}&authkey={$authkey}',
                    width  : '100%',
                    height : {$height},
